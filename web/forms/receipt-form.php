...
<!-- Form Name -->
<legend><center>Receipt Form</center></legend>
...
<div class="form-group">
  ...
  <div class="col-md-2">
    <select id="name" name="name" class="form-control" required>   <!-- get residents array from db -->
...
<div class="dropzone dz-clickable" id="myDrop">
    <div class="dz-default dz-message" data-dz-message="">
        <span><h3>Snap a pic of your receipt and..</h3></span>
        <span><h2>Touch or Drop image here</h2></span>
    </div>
</div>
</fieldset>
